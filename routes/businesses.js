...
router.post("/sendemail/:businessd", (req,res)=>{
    let massegeBody = "<h1>welcome to business</h1>";
    massegeBody += "<p>wsdfdsfdvzdcvdddddddddddddddddddddddddddddddddddddddd</p>";
    let subject = "welcome to Indianapolis";
    let mail = new Mail();
     if(mail.sendmail("aniket.dkamble18@gmail.com, rushi.khataki14@gmail.com",subject,massegeBody)){
